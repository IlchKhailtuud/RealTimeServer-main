...
public class GameLogic : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(durationUntilNextBalloon < 0)
        {
            ...
            // ServerToClientSignifiers.BalloonSpawned + "," + screenPositionXPercent + "," +
            //              screenPositionYPercent + "," + lastRefID;
...
public class BalloonInfo
{
    ...
    {
       return ServerToClientSignifiers.BalloonSpawned + "," + xPosPercent + "," +
            yPosPercent + "," + id;
    }
}
